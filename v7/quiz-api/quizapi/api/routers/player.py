...
@router.post("/create", tags=["Player"], response_model=Player, status_code=201)
@inject
...
@router.get("/all", tags=["Player"], response_model=Iterable[Player], status_code=200)
@inject
...
@router.get("/{player_id}", tags=["Player"], response_model=Player, status_code=200)
@inject
...
@router.put("/{player_id}", tags=["Player"], response_model=Player, status_code=201)
@inject
...
@router.delete("/{player_id}", tags=["Player"], status_code=204)
@inject
